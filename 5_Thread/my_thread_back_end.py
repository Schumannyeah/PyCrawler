...
# Main thread is the program itself and
# r is the child thread
# By setting the Daemon to True, then when the main thread ends,
# then the child thread ends as well
